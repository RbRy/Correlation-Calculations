function [ g2, tau , running_numer, running_denom] = getG2_cw( bin_width, max_time)
    ...
    running_numer = int32(zeros(1,max_bin*2+1));
    ...
    parfor i = 1:length(file_struct)
        ...
        try
            ...
            [numer,denom] = binsToCoincidences_g2_cw(bins,max_bin,pulse_spacing,max_pulse_distance,clock_bins);
